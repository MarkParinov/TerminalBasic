TerminalBasic - a simple terminal software that is capable of operating with files and directories on user's machine. Commands are sorted in different "modules" that provide different functionality.
